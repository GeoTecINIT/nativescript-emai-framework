...
import { StartPushProviderTask } from "nativescript-emai-framework/internal/tasks/data-collection/push-based";
...
describe("Start push provider task", () => {
    ...
    beforeEach(() => {
        ...
        task = new StartPushProviderTask(provider);
    });

    it("should have a predictable name", () => {
        expect(task.name).toEqual("startDetectingHumanActivityChanges");
    });
